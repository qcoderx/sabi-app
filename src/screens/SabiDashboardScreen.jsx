...
const SabiDashboardScreen = ({ onNavigate }) => {
  ...
  // STATE to manage the visibility of the "Coming Soon" modal
  ...
  return (
    <>
      {/* MODAL conditionally rendered with AnimatePresence for graceful transitions */}
      <AnimatePresence>
      ...
      <div className="flex flex-col h-full bg-sabi-gray-light overflow-y-auto">
        ...
        <motion.main 
          ...
          initial="hidden"
          animate="visible"
          className="flex-1 px-6 mt-6 pb-8" // Added bottom padding for scroll space
        >
          {/* HERO CARD (Unchanged) */}
          <motion.div
          ...
          <motion.div variants={itemVariants} className="grid grid-cols-2 gap-4">
            ...
            {/* Sabi Gigs Card - UPDATED with gradient and interactive onClick */}
            <div 
            ...
            >
              <div className="p-2 inline-block bg-sabi-white rounded-lg shadow-sm">
                <Briefcase className="text-sabi-purple"/>
              </div>
              <h3 className="font-bold text-sabi-dark">Sabi Gigs</h3>
              <div className="text-xs bg-sabi-gray-light text-sabi-gray font-bold px-2 py-0.5 rounded-full inline-block">Soon</div>
            </div>
            
            {/* Sabi Market Card - UPDATED with gradient and interactive onClick */}
            <div 
              onClick={handleComingSoon} 
            ...
            {/* Sabi Stay Card - UPDATED with gradient and interactive onClick */}
            <div 
              onClick={handleComingSoon} 
